# D1: BAC_BEM_Part1_Overview.md

## SRC-D1-§1 BAC/BEM Exam Prep Platform — Part I: Project Overview
...
## SRC-D1-§2 BAC/BEM Exam Prep Platform — Master Document
...
## SRC-D1-§2.1 1. What this platform is
...
## SRC-D1-§2.1.1 Full feature set (core learning + standard product surface)
...
## SRC-D1-§2.1.2 Product direction history (why some docs disagree with each other)
...
## SRC-D1-§2.2 2. Tech stack (current, per report.md/tech.md)
...
## SRC-D1-§2.2.1 Additional infrastructure for the full feature set (EPIC-15 → EPIC-24, planned)
...
## SRC-D1-§2.3.1 Repo layout (current)
...
## SRC-D1-§2.7 7. Known gaps (honest current state, per report.md §7)
